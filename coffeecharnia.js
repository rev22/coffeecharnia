...
(function(x) {
  ...
  return window.coffeecharnia = {
    ...
    setShowGutter: (function(x) {
      x.coffee = "(x)@> @view.coffeeArea.transformed?.renderer.setShowGutter x";
      return x;
    })(function(x) {
      var _ref;
      return (_ref = this.view.coffeeArea.transformed) != null ? _ref.renderer.setShowGutter(x) : void 0;
    }),
    showGutter: (function(x) {
      x.coffee = "@> @setShowGutter true";
      return x;
    })(function() {
      return this.setShowGutter(true);
    }),
    hideGutter: (function(x) {
      x.coffee = "@> @setShowGutter false";
      return x;
    })(function() {
      return this.setShowGutter(false);
    }),
    isConverting: false,
    target: null,
      ...
      camelcapBookmarklet: {
        ...
        setup: (function(x) {
          ...
          return ace.require(["ace/layer/text"], function(_arg) {
            ...
            })(new RegExp("([a-z][0-9]*[A-Z]|[@$#][0-9A-Za-z])", "g"));
            Text.prototype.$renderToken = patched;
            x = document.createElement("style");
            x.id = "ccapcss";
            x.innerHTML = ".ace_ccap { font-weight: bold; }";
