  ...
  return window.coffeecharnia = {
    ...
    spawn: (function(x) {
      ...
      return withCoffee(function() {
        ...
        app.setup();
        withAce(function() {
          var ace, aceCommand, chromeAndroidPasteFix, fnKeyDown, inject, keydownHandler, keyupHandler, ua, _ref1;
          ace = window.ace;
          app.libs.ace = ace;
          ...
          if (true) {
            ...
            window.addEventListener("keydown", keydownHandler, true);
            return window.addEventListener("keyup", keyupHandler, true);
          }
        });
