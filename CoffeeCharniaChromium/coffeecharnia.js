...
window.coffeecharniaLoader = {
  ...
  coffeecharniaBase: {
    ...
    inlineStyle: (function(x) {
      ...
      g = "" + x + ";" + y;
      return "position:absolute;overflow:auto;width:" + s + "%;height:" + s + "%;" + g + ";background:black;color:#ddd";
    }),
    accumulator: [],
    ...
    processSource: (function(x) {
      x.coffee = "(s)@> @targetObject? then (\"((x)->x.call(\" + @targetObject + \")) ()->\") + (\"\\n\" + s).replace(/\\n/g, \"\\n  \") else s";
      return x;
    })(function(s) {
      if (this.targetObject != null) {
        return ("((x)->x.call(" + this.targetObject + ")) ()->") + ("\n" + s).replace(/\n/g, "\n  ");
      } else {
        return s;
      }
    }),
  ...
  start: (function(x) {
    ...
    var DynmodPrinter, Error, HtmlGizmo, aceUrl, camelcapBookmarklet, charnia, coffeecharniaBase, coffeescriptUrl, document, element, htmlcup, htmlgizmo, window, withAce, withCoffee, _ref;
    charnia = this;
    coffeescriptUrl = this.config.coffeescriptUrl;
    aceUrl = this.aceUrl, coffeecharniaBase = this.coffeecharniaBase;
    _ref = this.lib, document = _ref.document, window = _ref.window, DynmodPrinter = _ref.DynmodPrinter, Error = _ref.Error, camelcapBookmarklet = _ref.camelcapBookmarklet, HtmlGizmo = _ref.HtmlGizmo, htmlcup = _ref.htmlcup;
    htmlcup = htmlcup.compileLib();
    htmlgizmo = {
      make: function(htmlcup) {
        var cssClass, homeEvent;
        ...
        return charnia.coffeecharniaLayout({
          htmlcup: htmlcup,
          style: coffeecharniaBase.inlineStyle(),
          ...
          header: function(opts) {
            ...
            return this.div(opts, function() {
              return this.style(".coffeecharniaContainer select { min-width:5em; max-width:30%; width:18em; }\n.coffeecharniaContainer select, .coffeecharniaContainer button { font-size:inherit; text-align:center;   }\n.coffeecharniaContainer .button { display:inline-block; }\n.coffeecharniaContainer button, .coffeecharniaContainer .button, .coffeecharniaContainer input, .coffeecharniaContainer select:not(:focus):not(:hover) { color:white; background:black; }\n/* select option:not(:checked) { color:red !important; background:black !important; } */\n/* option:active, option[selected], option:checked, option:hover, option:focus { background:#248 !important; } */\n.coffeecharniaContainer button, .coffeecharniaContainer .button { min-width:5%; font-size:220%; border: 2px outset grey; }\n.coffeecharniaContainer button:active, .coffeecharniaContainer .button.button-on { border: 2px inset grey; background:#248; }\n.coffeecharniaContainer .button input[type=\"checkbox\"] { display:none; }\n.coffeecharniaContainer .arrow { font-weight:bold;  }\n.coffeecharniaContainer .editArea { height:100%;width:100%;box-sizing:border-box; }");
            });
          },
          body: function(opts) {
